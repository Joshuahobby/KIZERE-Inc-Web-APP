import { agents, documents, devices, subscribers, roles, users, items, type Agent, type InsertAgent, type Document, type Device, type InsertDocument, type InsertDevice, type Role, type InsertRole, type User, type InsertUser, type Item } from "@shared/schema";
import { db } from "./db";
